...
def main():
    ...
    PDF_FOLDER = "downloaded_pdfs/dataset_1"
    USE_CACHE = False  # Установите False для принудительного перечитывания PDF файлов
    ...
    # ПРИМЕЧАНИЕ: Кластеризация отключена - все направления будут в одной программе
